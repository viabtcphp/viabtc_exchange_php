            ...
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-filter="my-nav">
                    ...
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd><a class="nav-link-item" href="javascript:;" data-title="合约交易市场" data-url="/manage/dm/market" data-id="">交易市场</a></dd>
                            <dd><a class="nav-link-item" href="javascript:;" data-title="合约设置" data-url="/manage/dm/dm" data-id="">合约设置</a></dd>
                            <dd><a class="nav-link-item" href="javascript:;" data-title="合约挂起订单" data-url="/manage/dm/dm/delegate" data-id="">挂起订单</a></dd>
                            <dd><a class="nav-link-item" href="javascript:;" data-title="合约持仓订单" data-url="/manage/dm/dm/hold" data-id="">持仓订单</a></dd>
                            <dd><a class="nav-link-item" href="javascript:;" data-title="合约历史订单" data-url="/manage/dm/dm/history" data-id="">历史订单</a></dd>
                        </dl>
                    </li>
