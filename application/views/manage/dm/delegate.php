    ...
    <div class="pagebox">
        ...
        <div class="mainbox">
            ...
            <div class="search_box layui-form">
                ...
                <button type="button" class="layui-btn search_btn" id="search_btn" data-url="/manage/dm/dm/delegate">搜索用户</button>
                <a class="layui-btn layui-btn-normal clear_search_btn" href="/manage/dm/dm/delegate">清空</a>
                <div class="clear"></div>
            </div>
