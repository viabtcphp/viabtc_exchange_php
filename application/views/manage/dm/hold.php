    ...
    <div class="pagebox">
        ...
        <div class="mainbox">
            ...
            <div class="search_box layui-form">
                ...
                <button type="button" class="layui-btn search_btn" id="search_btn" data-url="/manage/dm/dm/hold">搜索用户</button>
                <a class="layui-btn layui-btn-normal clear_search_btn" href="/manage/dm/dm/hold">清空</a>
                <div class="clear"></div>
            </div>
            ...
            <table class="layui-table" >
                ...
                <tbody>
                    ...
                    <tr style="position: relative;">
                        ...
                        <td><?php echo date('Y/m/d H:i:s', $dm['dm_open_time']); ?></td>
                        <td>
                        ...
                        <td><?php echo $dm['dm_close_future_price']; ?></td>
                        <td>
                        ...
                        <td style="position: relative; width: 70px;">
                            <a class="layui-btn layui-btn-danger layui-btn-xs delbtn" data-id="<?php echo $dm['dm_id']; ?>">插针爆仓</a>
                        </td>
                    </tr>
                    <?php }} ?>
                </tbody>
    ...
    <script>
        ...
        layui.use(['element', 'jquery', 'form', 'layer', 'upload', 'laydate'], function () {
            ...
            $('.delbtn').click(function(){
                ...
                var _this = $(this);
                var _dmId = _this.attr('data-id');

                layuiOpenIndex = layer.confirm(

                    '爆仓将会给用户造成巨量损失！<br />确定要 插针爆仓 ?<br />插针后，请等待合约结算。',
                    {
