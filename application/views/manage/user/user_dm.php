            ...
            <table class="layui-table" >
                ...
                <tbody>
                    ...
                    <tr style="position: relative;">
                        ...
                        <td><?php echo $dm['dm_open'] == 1 ? date('Y/m/d H:i:s', $dm['dm_open_time']) : '--'; ?></td>
                        <td><?php echo $dm['dm_close'] == 1 ? date('Y/m/d H:i:s', $dm['dm_close_time']) : '--'; ?></td>
                        <td>
                            <?php if($dm['dm_status'] == 1 && $dm['dm_open'] == 1){ ?>
                        ...
                        <td>
                            <a class="layui-btn <?php echo $dm['dm_status'] == 1 ? '' : 'layui-btn-danger'; ?> layui-btn-xs"><?php echo $dm['dm_status'] == 1 ? ($dm['dm_open'] == 1 ? ($dm['dm_close'] == 1 ? ($dm['dm_close_type'] == 1 ? '手动平仓' : '爆仓强平') : '正在持仓') : '挂起') : '已取消'; ?></a>
                        </td>
                    </tr>
                    <?php }} ?>
                </tbody>
