    ...
    <body>
        ...
        <script type="text/javascript">
                        ...
                        if (typeof event.data === 'string') {
                            ...
                            if (typeof _result === 'object') {
                                ...
                                if (_result.method == 'today.update') {
                                    ...
                                    market_line_item.children('.center_bar').text(_result.params[1].last);
                                    ...
                                    if (_last.minus != undefined) {
                                        ...
                                        market_line_item.find('.rate_bar').text((_rate > 0 ? '+' : '') + _rate + ' %');

                                        if (_rate >= 0) {

                                            market_line_item.find('.rate_bar').removeClass('down');
                                        }else{

                                            market_line_item.find('.rate_bar').addClass('down');
                                        }
                                    }
                                }
                            }
            ...
            layui.use(['layer', 'carousel'], function(){
                ...
                layer.open({
                  title: '温馨提示：'
                  ,content: '<span style="color: #F00;">本网站为演示站，不用于正式交易<br />DEMO币是平台币，可控行情</span>'
                });
