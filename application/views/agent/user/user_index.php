                ...
                <tbody class="layui-form">
                    ...
                    <tr style="position: relative;">
                        ...
                        <td style="position: relative; width: 330px;">
                            ...
                            <a class="layui-btn layui-btn-xs sendbtn window_show" data-title="充值记录 - <?php echo $user['user_name']; ?>" data-href="/agent/user/user/user_recharge/<?php echo $user['user_id']; ?>">充值记录</a>
                            <a class="layui-btn layui-btn-xs sendbtn window_show" data-title="提现记录 - <?php echo $user['user_name']; ?>" data-href="/agent/user/user/user_withdraw/<?php echo $user['user_id']; ?>">提现记录</a>

                            <a class="layui-btn layui-btn-xs sendbtn window_show" data-title="资产详情 - <?php echo $user['user_name']; ?>" data-href="/agent/user/user/user_asset/<?php echo $user['user_id']; ?>">资产详情</a>

                            <a class="layui-btn layui-btn-xs sendbtn window_show" data-title="合约订单 - <?php echo $user['user_name']; ?>" data-href="/agent/user/user/user_dm/<?php echo $user['user_id']; ?>">合约订单</a>
