 ...
 * 火币API
 */
class Huobi_model extends MY_Model {
    ...
    public function __construct()
    {
        ...
        $this->access = $this->config->item('huobi_access_key');
        $this->secret = $this->config->item('huobi_secret_key');
        $this->api = $this->config->item('huobi_api_host');

        date_default_timezone_set("Etc/GMT+0");
    }

    public function getSymbolNewPrice($symbol){
        ...
        $ret = $this->get_detail_merged($symbol);
